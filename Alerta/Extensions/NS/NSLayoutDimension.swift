...
internal extension NSLayoutDimension {
    ...
    @discardableResult
    func equals(_ constant: CGFloat) -> NSLayoutConstraint {
        return self.constraint(equalToConstant: constant).active()
    }

    @discardableResult
    func lessOrEquals(_ constant: CGFloat) -> NSLayoutConstraint {
        return self.constraint(lessThanOrEqualToConstant: constant).active()
    }

    @discardableResult
    func greaterOrEquals(_ constant: CGFloat) -> NSLayoutConstraint {
